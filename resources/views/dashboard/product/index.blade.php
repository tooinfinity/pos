            ...
            <form action="{{ route('product.index') }}" method="get">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <a type="" class="btn btn-success btn float-right" style="" href="{{ route('product.create') }}"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        <button type="submit" class="btn btn-success float-left"><i class="fas fa-search"></i> Search</button>
                    </div>
